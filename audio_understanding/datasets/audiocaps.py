r"""
Modified from https://github.com/AudioFans/audidata/tree/main/audidata/datasets/audiocaps.py
...
class AudioCaps(Dataset):
    ...
    [1] C. D. Kim, et al. AudioCaps: Generating Captions for Audios in The Wild, 
    NAACL-HLT 2019
